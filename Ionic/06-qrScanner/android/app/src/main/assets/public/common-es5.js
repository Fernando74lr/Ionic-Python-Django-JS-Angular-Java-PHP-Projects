(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
      ...
      var Register = /*#__PURE__*/function () {
        ...
        _createClass(Register, [{
          ...
          value: function determineType() {
            var startText = this.text.substr(0, 4);
    ...
    /***/
    function wie5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var DataLocalService = /*#__PURE__*/function () {
        function DataLocalService(storage, navCtrl, inAppBrowser, file, emailComposer, toastController) {
        ...
        _createClass(DataLocalService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return this.storage.get('records');
          ...
          key: "saveRecord",
          value: function saveRecord(format, text) {
          ...
          key: "openRecord",
          value: function openRecord(record) {
            ...
            switch (record.type) {
              ...
              case 'geo':
                // Open MapBox
                this.navCtrl.navigateForward("/tabs/tab2/map/".concat(record.text));
                break;
            }
          }
        }, {
          ...
          value: function sendEmail() {
            var arrTemp = [];
            var titles = 'Type, Format, Created at, Text\n';
            arrTemp.push(titles);
            this.records.forEach(function (record) {
              var line = "".concat(record.type, ", ").concat(record.format, ", ").concat(record.created, ", ").concat(record.text.replace(',', ' '), "\n");
              arrTemp.push(line);
            });
            this.createPhysicalFile(arrTemp.join(''));
          }
        }, {
          key: "createPhysicalFile",
          value: function createPhysicalFile(text) {
            var _this = this;
          ...
          key: "writeOnFile",
          value: function writeOnFile(text) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.next = 2;
                      return this.file.writeExistingFile(this.file.dataDirectory, 'registers.csv', text);
